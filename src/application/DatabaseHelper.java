...
//        try {
//            conn = DriverManager.getConnection("jdbc:h2:./data/userDatabase", "sa", "");
...
//        String sql = "CREATE TABLE IF NOT EXISTS users (username VARCHAR(255), password VARCHAR(255), role VARCHAR(50))";
...
//	}
//
//	public void register(String username, String password1, String email, String firstName, String middleName, String lastName, String preferredName) throws SQLException {
...
//	}
//
//	public boolean login(String username, String password1) throws SQLException {
