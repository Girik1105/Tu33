...
/*****
 * The StudentDashboard class creates the dashboard interface for students after
 * account setup.
 * 
 * It displays the student's personal information such as first name, middle
 * name, last name, and email. The screen also features a logout button to
...
public class StudentDashboard {
	 ...
	 * information and provides an option to log out and return to the login page.
	 * 
	 * @param primaryStage  The primary stage where the scene is displayed.
	 * @param preferredName The student's preferred name (not currently used in the
	 *                      dashboard).
	...
	public StudentDashboard(Stage primaryStage, String preferredName, String firstName, String middleName,
		...
		// layout.getChildren().addAll(title, userInfo, adminAction, textarea,
		// logoutArea);
