...
/**
 * EncryptionHelper class provides methods to encrypt and decrypt data using AES/CBC/PKCS5Padding.
 */
public class EncryptionHelper {
    ...
    /**
     * Constructor initializes the cipher with the Bouncy Castle provider.
     */
    ...
    /**
     * Encrypts the given plain text using the provided initialization vector.
     *
    ...
    /**
     * Decrypts the given cipher text using the provided initialization vector.
     *
